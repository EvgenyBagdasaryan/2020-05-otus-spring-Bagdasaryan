...
class CommentControllerTest {
    ...
    void commentListTest() {
        ...
        //final Comment comment = new Comment(UUID.randomUUID().toString(), "comment1");
        ...
        /*when(commentService.getCommentsByBookId(eq(bookId)))
        ...
        mockMvc.perform(get("/api/comments/" + bookId)
            ...
            .andExpect(jsonPath("$.content[0].text").value(comment.getName()))
